...
const StudentModal = (props) => {
  ...
  const cargarDatosDiplomado = async (token) => {
  ...
  return (
    <div>
      <Dialog
        ...
        header={props.editar ? 'Editar Estudiante' : 'Registrar Estudiante'}
        modal
        className='p-fluid'
      ...
      >
        ...
        <div className='grid p-fluid'>
          ...
          <div className='col-12 md:col-6'>
            ...
            <MultiSelect id='graduate' name='graduate' value={props.user.graduate} options={datosDiplomado} onChange={(e) => props.onInputChange(e, 'graduate')} optionLabel="name" placeholder="Seleccione diplomado" maxSelectedLabels={3} />
